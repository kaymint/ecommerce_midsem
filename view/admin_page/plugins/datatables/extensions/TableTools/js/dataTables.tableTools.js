...
TableTools.prototype = {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		if ( oSetDT.oScroll.sX !== "" || oSetDT.oScroll.sY !== "" )
		{
			...
			// If the table redraws while in print customer_view, the DataTables scrolling
	...
	"_fnPrintScrollStart": function ()
	{
		 ...
		 * in print customer_view. Note that this section of code is more or less verbatim from DT 1.7.0
		 */
...
TableTools.BUTTONS = {
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Print customer_view</h6><p>Please use your browser's print function to "+
		  "print this table. Press escape when finished.</p>",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "View print customer_view",
